...
namespace NeoActPlugin.Renderer
{
    public class Renderer : IDisposable
    {
        const string CRASH_SERVER = "https://2b5480083174358bcc20a11e7cf0c097@o4508980057866240.ingest.de.sentry.io/4508980068745296";
        ...
        public void SetApi(object api)
        {
            _api = api;
            if (api != null)
                _browser.JavascriptObjectRepository.Register("NeoActPluginApi", api, isAsync: true);
        }
        ...
        private void Browser_FrameLoadStart(object sender, FrameLoadStartEventArgs e)
        {
            ...
            if (_api != null)
            {
                var initScript = @"(async () => {
                    await CefSharp.BindObjectAsync('NeoActPluginApi');
                    NeoActPluginApi.overlayName = " + JsonConvert.SerializeObject(this.overlayName) + @";
                    NeoActPluginApi.overlayUuid = " + JsonConvert.SerializeObject(this.overlayUuid) + @";
                    NeoActPluginApi.ready = true;
                })();";
        ...
        public static void Initialize(string pluginDirectory, string appDataDirectory, bool reportErrors)
        {
            if (!initialized)
            {
...
#else
                var cefPath = Path.Combine(appDataDirectory, "NeoActPluginCef", Environment.Is64BitProcess ? "x64" : "x86");
#endif
                ...
                var cefSettings = new CefSettings
                {
                    ...
                    Locale = lang,
                    CachePath = Path.Combine(appDataDirectory, "NeoActPluginCache"),
                    MultiThreadedMessageLoop = true,
                    LogFile = Path.Combine(appDataDirectory, "NeoActPluginCEF.log"),
#if DEBUG
        ...
        public static void EnableErrorReports(string appDataDirectory)
        {
            ...
            var cfgText = $@"
# This file was generated by NeoActPlugin to configure CEF's Crahspad reporter.
# For details on the purpose of this file see https://bitbucket.org/chromiumembedded/cef/wiki/CrashReporting.md.
# Please don't modify this file manually. Instead, disable it in NeoActPlugin's settings.

[Config]
ProductName=NeoActPlugin
ProductVersion={version}
AppName=ACT_NeoActPlugin
...
";
        ...
        // IJavascriptCallback can't be used outside NeoActPlugin.Renderer. This helper allows other code
